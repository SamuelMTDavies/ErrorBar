...
class Flushbar<T extends Object> extends StatefulWidget {
  Flushbar(
      {Key key,
        ...
        AlertType typeOfAlert = AlertType.SUCCESS,
        Form userInputForm})
      : this.title = title,
  ...
  /// A [SecondaryButton] widget if you need an action from the user.
  final SecondaryButton mainButton;
...
class _FlushbarState<K extends Object> extends State<Flushbar> with TickerProviderStateMixin {
    ...
    return Align(
      ...
      child: Material(
        ...
        child: SafeArea(
          ...
          left: false,
          right: false,
          child: CustomPaint(painter: ShapesPainter(alertType: widget.typeOfAlert),
            child:_getFlushbar(),
          ),
        ),
      ),
    ...
    return DecoratedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(left: 16, right: 16, bottom: 8.0, top: 16.0),
            child: FocusScope(
            ...
            children: <Widget>[
              ...
              Padding(
                padding: EdgeInsets.only(
                  ...
                  left: widget.padding.left,
                  right: widget.padding.right,
                  bottom: widget.padding.bottom + 50,
                ),
  ...
  SecondaryButton _getMainActionButton() {
    if (widget.mainButton != null) {
      return widget.mainButton;
    } else {
      return SecondaryButton(buttonText: 'GOT IT',onPressed: (){},);
    }
  }
}
